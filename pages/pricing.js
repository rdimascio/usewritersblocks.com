...
const tiers = [
	...
	},
	{
		...
		description: 'Enjoy one year of updates and support for an unlimited number of your websites.',
	...
	},
	{
		...
		description: 'Enjoy updates and support for an unlimited number of sites, for the lifetime of Writer\'s Blocks.',
		...
		<>
					...
					<div className="relative">
						...
						<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
							<div className="max-w-md mx-auto space-y-4 lg:max-w-5xl lg:grid lg:grid-cols-2 lg:gap-5 lg:space-y-0">
								{tiers.filter((tier) => tier.key !== 'lifetime').map((tier) => (
            ...
            <div className="max-w-md mx-auto space-y-4 lg:space-y-0 lg:max-w-5xl lg:flex mt-8 sm:mt-12 lg:mt-16">
              <div className="flex-1 px-6 py-8 lg:p-12">
                <h3 className="text-2xl font-bold text-gray-900 sm:text-3xl sm:tracking-tight" id={lifetimeTier.key}>{lifetimeTier.name}</h3>
                <p className="mt-6 text-base text-gray-500">{lifetimeTier.description}</p>
                <div className="mt-8">
              ...
              <div className="py-8 px-6 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
                ...
                <div className="mt-4 flex items-center justify-center text-5xl tracking-tight font-bold text-gray-900">
                  ...
                  <span className="ml-3 text-xl font-medium text-gray-500 tracking-normal">USD</span>
                </div>
                <div className="mt-6">
                  <div className="rounded-md shadow">
                    <a
