...
export default function Home() {
	...
	return (
		<>
			...
			<section className="h-[calc(80vh-4.5rem)] flex flex-col justify-center mx-auto w-full max-w-7xl px-4 sm:px-6 text-center">
				<h1 className="tracking-tight font-extrabold text-gray-900 dark:text-gray-100 text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl">
					...
					<button
						...
						className={cx(
							'relative',
							isAnnotationActive
								? 'before:absolute before:z-[-1] before:bg-yellow-200 dark:before:bg-yellow-500 before:h-4/6 before:w-full before:bottom-[-5px] before:left-[-5px] before:rotate-2'
								: 'font-extrabold'
						)}
