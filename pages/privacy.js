				...
				<div className="relative px-4 sm:px-6 lg:px-8">
					<div className="text-lg max-w-prose mx-auto">
						...
						<p className="mt-8 text-xl text-gray-500 leading-8">
							At Writer's Blocks, accessible from https://usewritersblocks.com,
							privacy of our visitors is an absolute priority. We only ask for
							personal information when we actually need it—like our payment form. We
							use fair and lawful means to collect any data, and only with your
					...
					<div className="mt-16 prose prose-indigo prose-lg text-gray-500 mx-auto">
						...
						<ol>
							<li>
								Stripe and PayPal, for secure payment processing. We do not, and
								will never, store any payment card details.
							</li>
						</ol>

						<p>
							We don’t share any personally identifying information publicly or with
							third-parties, except when required to by law or in response to valid
						...
						<p>
							We do not collect information such as your computer’s Internet Protocol
						...
						<p>
							...
							respective privacy policies. We advise you to review the Privacy Policy
						...
						<p>
							...
							let you know via email and/or a prominent notice on our website, prior
